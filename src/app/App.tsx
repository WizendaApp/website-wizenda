    ...
    <div className="relative min-h-screen w-full">
      ...
      <section className="relative h-[500px] bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://i.ibb.co/Z1NXpbSX/Rectangle-4.png')` }}>
        <div className="max-w-7xl mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <div className="flex gap-4">
            <button className="bg-orange-500 text-white px-8 py-3 rounded-[5px] font-medium">Começar</button>
            <button className="px-8 py-3 rounded-[5px] border border-white bg-white/10 backdrop-blur-sm text-white font-medium">Baixar o App</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid justify-center gap-6" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(120px, max-content))" }}>
            {["https://i.ibb.co/05R3Jqx/domestic.png", "https://i.ibb.co/jZfB2y48/ruby.png"].map((logo, index) => (
              <div key={index} className="flex items-center justify-center h-14 px-3">
                <img src={logo} alt={`Parceiro ${index + 1}`} className="h-15 w-auto object-contain grayscale opacity-40" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12">Conecte-se com oportunidades e eventos em Angola</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <button className="text-orange-500 font-medium">Ver tudo →</button>
          </div>
            ...
            {[
              ...
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md">
                <div className="relative h-65">
                  ...
                  <div className="absolute top-4 right-4 bg-white px-2 py-1 rounded-full text-xs font-medium">Popular</div>
                </div>
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="bg-orange-500 text-white px-4 py-2 rounded-full text-sm">Reservar</button>
                  </div>
                </div>
              </div>
            ))}
              ...
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="bg-orange-500 text-white px-4 py-2 rounded-full text-sm">Ver mais</button>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-2xl shadow-lg relative flex flex-col">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full justify-center md:justify-start">
                <a href="#" className="bg-black text-white px-6 py-3 rounded-2xl flex items-center gap-3 shadow-lg">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><button onClick={() => setCurrentPage("home")}>Sobre Nós</button></li>
              <li><button onClick={() => setCurrentPage("lugares")}>Destinos</button></li>
